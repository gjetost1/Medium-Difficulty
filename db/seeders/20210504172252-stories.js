...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Stories', [{
      ...
      createdAt: new Date(),
      updatedAt: new Date(),
      storyImage: '/storyImgs/nightmare.png'
    },{
      ...
      createdAt: new Date(),
      updatedAt: new Date(),
      storyImage: '/storyImgs/zorldo.png'
    },{
      ...
      createdAt: new Date(),
      updatedAt: new Date(),
      storyImage: '/storyImgs/prince.png'
    },{
      ...
      createdAt: new Date(),
      updatedAt: new Date(),
      storyImage: '/storyImgs/punch.png'
    }, {
      ...
      createdAt: new Date(),
      updatedAt: new Date(),
      storyImage: '/storyImgs/fight.png'
    }, {
      ...
      createdAt: new Date(),
      updatedAt: new Date(),
      storyImage: '/storyImgs/wrestling.png'
    }
    ], {});
  },
